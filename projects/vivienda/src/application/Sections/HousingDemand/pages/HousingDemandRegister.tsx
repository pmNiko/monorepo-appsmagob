...
import { disableButton, Environments } from "@shared/infra";
import {
  Captcha,
  CustomPopUp,
  InfoModalResponse,
...
import { RegistroDHParams, RegistroDHResponse } from "../interfaces";
import { HousingDemandRegisterTable } from "../components/HousingDemandRegisterTable";
...
const HousingDemandRegister = () => {
  const [validCaptcha, setValidCaptcha] = useState(false);
  const [inputStructure, setInputStructure] = useState(dniInputStructure);
  const handlerRegister = useQueryState<RegistroDHResponse[], RegistroDHParams>(
    FN_SGD.IVH_Registro_Demanda_Habitacional,
    {}
  );
  ...
  return (
    <MunismaCard
      ...
      mt={5}
      mb={4}
      title="Registro de Demanda Habitacional"
    >
...
export default HousingDemandRegister;
